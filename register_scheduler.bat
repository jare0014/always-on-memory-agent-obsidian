...
SET BAT_PATH="C:\Users\jare0\Documents\Obsidian\04_Projects\always-on-memory-agent\run_agentic_trader.bat"

echo Registering Robinhood Agentic Windows OS Tasks for always-on-memory-agent...
